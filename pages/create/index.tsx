            ...
            <div className="flex flex-auto -mx-3 mb-2">
                ...
                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    ...
                    <div className="relative">
                        <select name='state' value={state} onChange={(e)=>setState(e.target.value)} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
