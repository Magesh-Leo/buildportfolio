          ...
          <div className='w-3/5 p-5'> 
            ...
            <div className='py-10'>
              ...
              <div className='flex flex-col items-center'>
                ...
                <a href="#" className='border-2 border-green-500 text-green-500 rounded-full py-2 px-12 inline-block font-semibold hover:bg-green-500 hover:text-white'>Sign in</a>
              </div>
            </div>
          </div>
          {/* Signup section */}
